...
def generate_week1() -> list[DatasetRecord]:
    ...
    return [
        ...
        _hf(
            "fineweb_edu_en",
            "FineWeb-Edu (English HuggingFace)",
            "HuggingFaceFW/fineweb-edu",
            phase=1,
            week=1,
            domain=DataDomain.FOUNDATION_TEXT,
        ...
        _hf(
            ...
            phase=1,
            week=1,
            domain=DataDomain.INDIAN_LANGUAGES,
        ...
        _hf(
            "c4_en",
            "C4 (Colossal Clean Crawled Corpus - English)",
            "allenai/c4",
            phase=1,
            week=1,
            domain=DataDomain.FOUNDATION_TEXT,
...
def generate_week2() -> list[DatasetRecord]:
    ...
    for lang_code, lang_name, est_records in [
        ...
        records.append(
            _hf(
                f"sangraha_{lang_code}",
                f"Sangraha ({lang_name})",
                "ai4bharat/sangraha",
                phase=1,
                week=2,
                domain=DataDomain.INDIAN_LANGUAGES,
    ...
    for lang_code, lang_name, est_records in [
        ...
        records.append(
            _hf(
                f"indiccorp_{lang_code}",
                f"IndicCorp ({lang_name})",
                "ai4bharat/indiccorp",
                phase=1,
                week=2,
                domain=DataDomain.INDIAN_LANGUAGES,
    ...
    for lang_code, lang_name in [
        ...
        records.append(
            _hf(
                f"shrutilipi_{lang_code}",
                f"Shrutilipi ({lang_name})",
    ...
    for split_name in ["dev", "devtest"]:
        records.append(
            _hf(
                f"flores200_{split_name}",
                f"FLORES-200 ({split_name})",
                "facebook/flores",
                phase=1,
                week=2,
                domain=DataDomain.MULTILINGUAL,
                hf_config="default",
    ...
    for lang_code in ["hi", "bn", "ta", "te", "mr", "gu", "ml", "kn", "pa", "or", "as", "ur"]:
        records.append(
            _hf(
                f"oscar_{lang_code}",
                f"OSCAR (Multilingual - {lang_code})",
    ...
    for lang_code in ["hi", "bn", "ta", "te", "mr", "gu", "ml", "kn", "pa"]:
        records.append(
            _hf(
                f"culturax_{lang_code}",
                f"CulturaX ({lang_code})",
                "uonlp/CulturaX",
                phase=1,
                week=2,
                domain=DataDomain.MULTILINGUAL,
...
def generate_week3() -> list[DatasetRecord]:
    ...
    return [
        ...
        _hf(
            "open_orca",
            "Open-Orca (Instruction Tuning)",
            "Open-Orca/OpenOrca",
            phase=1,
            week=3,
            domain=DataDomain.INSTRUCTION,
        ...
        _hf(
            "numinamath",
            "NuminaMath (Math Problem Solving)",
        ...
        _hf(
            ...
            "Natural Instructions (NLP Tasks)",
        ...
        _hf(
            "capybara",
            "Capybara (Long-Form Instructions)",
            "LDJnr/Capybara",
            phase=1,
            week=3,
            domain=DataDomain.INSTRUCTION,
...
def generate_week4() -> list[DatasetRecord]:
    ...
    return [
        ...
        _hf(
            "common_voice_en",
            "Common Voice (English Speech)",
            "mozilla-foundation/common_voice_19_0",
            phase=1,
            week=4,
            domain=DataDomain.AUDIO,
            hf_config="en",
            estimated_records=2_000_000,
        ...
        _git_lfs(
            "github_awesome_ml",
            "GitHub Awesome ML Repos (Mirror)",
        ...
        _hf(
            "the_stack_python_extra",
            "The Stack Python (Extra subset)",
        ...
        _hf(
            "gigaspeech",
            "GigaSpeech (Large Speech Corpus)",
