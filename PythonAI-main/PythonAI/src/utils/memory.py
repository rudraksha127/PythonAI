...
class AgentMemory:
    def __init__(self, db_path: str = "python_brain_godmode/memory_db"):
        ...
        self.collection = self.client.get_or_create_collection(name="swarm_memory", metadata={"hnsw:space": "cosine"})
    ...
    def search_memory(self, session_id: str, query: str, n_results: int = 3) -> list:
        ...
        try:
            results = self.collection.query(query_texts=[query], n_results=n_results, where={"session_id": session_id})
