...
export const THEMES = {
  // Default dark theme - Modern deep blue with warm accents
  dark:       { bg:'#1a1a2e', fg:'#e8e8f0', panel:'#16213e', border:'#0f3460', red:'#e94560' },
  // Light theme - Warm cream with soft brown accents
  light:      { bg:'#faf8f5', fg:'#4a4a5a', panel:'#ffffff', border:'#e8e6e0', red:'#e07b65' },
  // Midnight theme - Deep dark with cool blue tones
  midnight:   { bg:'#0a0e1a', fg:'#b8c5d9', panel:'#0f1628', border:'#1e3a5f', red:'#4fc3f7' },
  // Paper theme - Clean white with elegant dark text
  paper:      { bg:'#ffffff', fg:'#2c2c3e', panel:'#f8f9fa', border:'#e2e4e8', red:'#e53935' },
  // Cyberpunk - Neon cyan on deep black
  cyberpunk:  { bg:'#050510', fg:'#00f5ff', panel:'#0a0a1a', border:'#0044ff', red:'#ff00aa' },
  // Retrowave - Purple and pink gradient vibes
  retrowave:  { bg:'#1a0a2e', fg:'#ff6b9d', panel:'#2d1b69', border:'#9b30ff', red:'#ff6b9d' },
  // Forest - Natural green tones
  forest:     { bg:'#1a2e1a', fg:'#a8d5a2', panel:'#142414', border:'#2d5a2d', red:'#66bb6a' },
  // Ocean - Deep sea blue theme
  ocean:      { bg:'#0a1628', fg:'#64d2ff', panel:'#0d2137', border:'#1a4a7a', red:'#00bcd4' },
  // Ume (Plum Blossom) - Soft pink and purple
  ume:        { bg:'#2d1b3e', fg:'#f5c2e7', panel:'#1e1430', border:'#6c4675', red:'#f48fb1' },
  // Copper - Warm metallic tones
  copper:     { bg:'#1e1410', fg:'#e8c39e', panel:'#140f0a', border:'#7a5533', red:'#d4764e' },
  // Terminal - Classic green on black
  terminal:   { bg:'#0a0a0a', fg:'#00ff41', panel:'#0f0f0f', border:'#003b00', red:'#00ff41' },
  // Organs - Deep red anatomical theme
  ...
  // GPT - Inspired by ChatGPT interface
  gpt:        { bg:'#212121', fg:'#ececec', panel:'#171717', border:'#424242', red:'#949494',
                advanced: { sendBtnBg: '#949494', sendBtnHover: '#7f7f7f',
                            ...
                            inputBg: '#2f2f2f' } },
  // Claude - Inspired by Claude interface
  claude:     { bg:'#262624', fg:'#f5f4f0', panel:'#30302e', border:'#4a4a47', red:'#c6613f' },
  // Cute - Soft pink kawaii theme
  cute:       { bg:'#fff0f5', fg:'#d4608a', panel:'#fff8fa', border:'#f0c0d0', red:'#ff6b9d' },
  // Glassmorphism - Ultra aesthetic colorful glass effect
  glass:      { bg:'#0f0c29', fg:'#e8e8f0', panel:'rgba(255,255,255,0.08)', border:'rgba(255,255,255,0.18)', red:'#ff6b9d',
                advanced: { sendBtnBg: '#ff6b9d', sendBtnHover: '#ff8cb8',
                            userBubbleBg: 'rgba(255,107,157,0.15)', aiBubbleBg: 'rgba(255,255,255,0.06)',
                            inputBg: 'rgba(255,255,255,0.06)', inputBorder: 'rgba(255,255,255,0.15)',
                            bubbleBorder: 'rgba(255,255,255,0.12)',
                            sidebarBg: 'rgba(255,255,255,0.05)', brandColor: '#a855f7',
                            hamburgerColor: '#e8e8f0', codeBg: 'rgba(0,0,0,0.3)', codeFg: '#e8e8f0',
                            toggleActive: '#a855f7' } },
};
...
const THEME_DEFAULT_PATTERN = {
  ...
  ume:        'petals',
  cute:       'sparkles',
  glass:      'none', // Glass theme uses gradient backgrounds instead
};
...
const THEME_DEFAULT_EFFECT_COLOR = {
  ...
  cute:       '#ff8cb8',
  ume:        '#f5a0c0',
  glass:      '#a855f7', // Purple glow for glass theme
};
...
const THEME_DEFAULT_FROSTED = {
  lavender:   true,
  glass:      true, // Glass theme always uses frosted glass
};
