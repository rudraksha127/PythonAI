...
def _build_default_registry() -> ModelRegistry:
    ...
    providers = [
        ProviderDescriptor(
            "openai", "OpenAI", "https://api.openai.com/v1", "OPENAI_API_KEY", default_model="gpt-4o", priority=1
        ),
        ProviderDescriptor(
            "gemini",
            "Google Gemini",
        ...
        ProviderDescriptor("xai", "xAI Grok", "https://api.x.ai/v1", "XAI_API_KEY", default_model="grok-2", priority=2),
        ProviderDescriptor(
            "openrouter",
            "OpenRouter",
    ...
    GPT_CAPS = ModelCapabilities(  # noqa: N806
        vision=True, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=True
    )
    GPT_R_CAPS = ModelCapabilities(  # noqa: N806
        vision=True, streaming=True, function_calling=True, json_mode=True, reasoning=True, precise_token_count=True
    )
    ...
    reg.register_models(
        [
            ModelDescriptor(
                "gpt-4o", "GPT-4o", "openai", GPT_CAPS, 128_000, 16_384, ["chat", "vision", "coding"], True, 2.50, 10.0
            ),
            ModelDescriptor(
                "gpt-4o-mini",
                "GPT-4o Mini",
            ...
            ModelDescriptor(
                "gpt-4-turbo", "GPT-4 Turbo", "openai", GPT_CAPS, 128_000, 4_096, ["chat", "coding"], False, 10.0, 30.0
            ),
            ModelDescriptor(
                "gpt-4.1", "GPT-4.1", "openai", GPT_CAPS, 1_047_576, 32_768, ["chat", "coding"], False, 2.0, 8.0
            ),
            ModelDescriptor(
                "gpt-4.1-mini",
                "GPT-4.1 Mini",
            ...
            ModelDescriptor(
                "o1", "o1", "openai", GPT_R_CAPS, 200_000, 100_000, ["chat", "reasoning", "coding"], False, 15.0, 60.0
            ),
            ModelDescriptor(
                "o3-mini",
                "o3 Mini",
    ...
    # ── Gemini Models ───────────────────────────────────────────
    GEMINI_CAPS = ModelCapabilities(  # noqa: N806
        vision=True, streaming=True, function_calling=True, json_mode=True, reasoning=True, precise_token_count=False
    )
    reg.register_models(
        [
            ModelDescriptor(
    ...
    # ── DeepSeek Models ─────────────────────────────────────────
    DS_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    DS_R_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=True, precise_token_count=False
    )
    reg.register_models(
        [
            ModelDescriptor(
    ...
    # ── Mistral Models ──────────────────────────────────────────
    MISTRAL_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    reg.register_models(
        [
            ...
            ModelDescriptor(
                "codestral", "Codestral", "mistral", MISTRAL_CAPS, 32_768, 8_192, ["chat", "coding"], False, 0.0, 0.0
            ),
        ]
    )

    # ── Groq Models ─────────────────────────────────────────────
    GROQ_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    reg.register_models(
        [
    ...
    # ── Anthropic Models ────────────────────────────────────────
    ANTH_CAPS = ModelCapabilities(  # noqa: N806
        vision=True, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    ANTH_R_CAPS = ModelCapabilities(  # noqa: N806
        vision=True, streaming=True, function_calling=True, json_mode=True, reasoning=True, precise_token_count=False
    )
    reg.register_models(
        [
    ...
    # ── Ollama / Local Models ───────────────────────────────────
    LOCAL_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    LOCAL_R_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=True, precise_token_count=False
    )
    reg.register_models(
        [
            ModelDescriptor(
                "qwen2.5-coder:14b", "Qwen 2.5 Coder 14B", "ollama", LOCAL_CAPS, 32_768, 8_192, ["chat", "coding"], True
            ),
            ModelDescriptor(
                "qwen2.5-coder:7b", "Qwen 2.5 Coder 7B", "ollama", LOCAL_CAPS, 32_768, 8_192, ["chat", "coding"], False
            ),
            ModelDescriptor(
            ...
            ModelDescriptor(
                "llama3.1:8b", "Llama 3.1 8B", "ollama", LOCAL_CAPS, 128_000, 8_192, ["chat", "coding"], False
            ),
            ModelDescriptor(
                "deepseek-r1:14b",
                "DeepSeek R1 14B",
            ...
            ModelDescriptor("phi4:14b", "Phi-4 14B", "ollama", LOCAL_CAPS, 16_384, 4_096, ["chat", "coding"], False),
        ]
    )

    # ── xAI Models ──────────────────────────────────────────────
    XAI_CAPS = ModelCapabilities(  # noqa: N806
        vision=True, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    reg.register_models(
        [
            ModelDescriptor(
                "grok-2", "Grok 2", "xai", XAI_CAPS, 128_000, 8_192, ["chat", "vision", "coding"], True, 2.0, 10.0
            ),
            ModelDescriptor(
                "grok-2-vision", "Grok 2 Vision", "xai", XAI_CAPS, 32_768, 8_192, ["chat", "vision"], False, 5.0, 15.0
            ),
        ]
    )

    # ── SambaNova Models ────────────────────────────────────────
    SAMBA_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    reg.register_models(
        [
    ...
    # ── Cerebras Models ─────────────────────────────────────────
    CEREBRAS_CAPS = ModelCapabilities(  # noqa: N806
        vision=False, streaming=True, function_calling=True, json_mode=True, reasoning=False, precise_token_count=False
    )
    reg.register_models(
        [
